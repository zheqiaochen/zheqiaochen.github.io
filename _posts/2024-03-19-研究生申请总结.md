...
经过这个流程之后，你应该会有一篇1000词左右的长文章和500词左右的短文章，之后还需要经过多次的打磨，最终得到可以提交的版本。不同学校对SoP的长度要求不同，我申请的学校大部分设置了500或者1000的词数限制，也有一些学校会有800词的限制，这两种长度的文章经过调整应该可以符合大多数学校SoP的字数要求。
